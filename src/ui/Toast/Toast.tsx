...
export const Toast = (props: ToastProps) => {
  ...
  return (
    <div
      class="
        w-80 border rounded-lg shadow-lg p-4 transition-all duration-300 ease-in-out transform
            ...
            <Show when={props.toast.closable}>
              <div class=" flex-shrink-0">
                <button
                  ...
                  class="
                    headless data-[type=success]:bg-green-50 data-[type=success]:border-green-200 data-[type=success]:text-green-800
                  data-[type=error]:bg-red-50 data-[type=error]:border-red-200 data-[type=error]:text-red-800
                  data-[type=warning]:bg-yellow-50 data-[type=warning]:border-yellow-200 data-[type=warning]  :text-yellow-800
